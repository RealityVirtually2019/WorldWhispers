		...
		private void PerformDeviceConnection()
		{
			...
			switch (sessionStatus)
			{
				...
				case SessionStatus.Open:
					...
					_deviceToConnect.variantId = (VariantId)WearableGetDeviceVariantID();
					...
					if (!Enum.IsDefined(typeof(VariantId), _deviceToConnect.variantId))
					{
						_deviceToConnect.variantId = VariantId.Undefined;
					}
